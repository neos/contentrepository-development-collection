...
Feature: Set properties of a node
  ...
  # bool property tests
  Scenario: Try to set a bool node property to a non-bool value
    When the command SetNodeProperties is executed with payload and exceptions are caught:
      | Key                       | Value                              |
      | contentStreamIdentifier   | "cs-identifier"                    |
      | nodeAggregateIdentifier   | "nody-mc-nodeface"                 |
      | originDimensionSpacePoint | {"market": "DE", "language": "de"} |
      | propertyValues            | {"bool": 4}                        |
    ...
    When the command SetNodeProperties is executed with payload and exceptions are caught:
      ...
      | nodeAggregateIdentifier   | "nody-mc-nodeface"                 |
      | originDimensionSpacePoint | {"market": "DE", "language": "de"} |
      | propertyValues            | {"bool": "Nody McNodeface"}        |
    Then the last command should have thrown an exception of type "PropertyTypeDoesNotMatchNodeTypeSchema"
  ...
  # int property tests
  Scenario: Try to set an int node property to a non-int value
    When the command SetNodeProperties is executed with payload and exceptions are caught:
      | Key                       | Value                              |
      | contentStreamIdentifier   | "cs-identifier"                    |
      | nodeAggregateIdentifier   | "nody-mc-nodeface"                 |
  ...
  Scenario: Try to set a float node property to a non-float value
    When the command SetNodeProperties is executed with payload and exceptions are caught:
      | Key                       | Value                              |
      | contentStreamIdentifier   | "cs-identifier"                    |
      | nodeAggregateIdentifier   | "nody-mc-nodeface"                 |
  ...
  Scenario: Try to set a string node property to a non-string value
    When the command SetNodeProperties is executed with payload and exceptions are caught:
      | Key                       | Value                              |
      | contentStreamIdentifier   | "cs-identifier"                    |
      | nodeAggregateIdentifier   | "nody-mc-nodeface"                 |
  ...
  Scenario: Try to set a array node property to a non-array value
    When the command SetNodeProperties is executed with payload and exceptions are caught:
      | Key                       | Value                              |
      | contentStreamIdentifier   | "cs-identifier"                    |
      | nodeAggregateIdentifier   | "nody-mc-nodeface"                 |
  ...
  Scenario: Try to set a value object node property to a value that is not of the matching class
    When the command SetNodeProperties is executed with payload and exceptions are caught:
      | Key                       | Value                              |
      | contentStreamIdentifier   | "cs-identifier"                    |
      | nodeAggregateIdentifier   | "nody-mc-nodeface"                 |
  ...
  # date property tests
  Scenario: Try to set a date node property to a non-date value
    When the command SetNodeProperties is executed with payload and exceptions are caught:
      | Key                       | Value                              |
      | contentStreamIdentifier   | "cs-identifier"                    |
      | nodeAggregateIdentifier   | "nody-mc-nodeface"                 |
  ...
  # uri property tests
  Scenario: Try to set a uri node property to a non-URI value
    When the command SetNodeProperties is executed with payload and exceptions are caught:
      | Key                       | Value                              |
      | contentStreamIdentifier   | "cs-identifier"                    |
      | nodeAggregateIdentifier   | "nody-mc-nodeface"                 |
  ...
  Scenario: Try to set an entity node property to a value that is not of the same class
    When the command SetNodeProperties is executed with payload and exceptions are caught:
      | Key                       | Value                              |
      | contentStreamIdentifier   | "cs-identifier"                    |
      | nodeAggregateIdentifier   | "nody-mc-nodeface"                 |
  ...
  Scenario: Try to set an array of entities node property to something else than an array of those entities
    When the command SetNodeProperties is executed with payload and exceptions are caught:
      | Key                       | Value                              |
      | contentStreamIdentifier   | "cs-identifier"                    |
      | nodeAggregateIdentifier   | "nody-mc-nodeface"                 |
