...
trait HistoryTrait
{
    ...
    protected function setupEventSourcedTrait()
    {
        ...
        $this->history = $this->getObjectManager()->get(ContentGraphInterface::class);
    ...
    {
        $subgraph = $this->history->getSubgraphByIdentifier($this->contentStreamIdentifier, $this->dimensionSpacePoint, $this->visibilityConstraints);
    ...
    protected function getRootNodeAggregateIdentifier(): ?NodeAggregateIdentifier
    {
        ...
        $sitesNodeAggregate = $this->history->findRootNodeAggregateByType($this->contentStreamIdentifier, NodeTypeName::fromString('Neos.Neos:Sites'));
